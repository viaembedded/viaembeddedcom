...
function ubermenu_settings_links(){
	...
	if( ubermenu_is_pro() ) echo '<a target="_blank" class="button button-secondary ubermenu-button-support" href="'.ubermenu_get_support_url().'"><i class="fa fa-life-ring"></i> Support</a> ';
}

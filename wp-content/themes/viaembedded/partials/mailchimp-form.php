...
<div id="mc_embed_signup">
    <form action="//viaembedded.us8.list-manage.com/subscribe/post?u=fc68831e4ac2cd70f51e2693a&amp;id=8e353536e3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        <div id="mc_embed_signup_scroll">
            	<h2>Sign up to be notified of new software releases!</h2>
		    ...
		    <ul>
			    ...
			    <li>
				    <input type="checkbox" value="2048" name="group[16297][2048]" id="mce-group[16297]-16297-11">
				    <label for="mce-group[16297]-16297-11">ARTiGO A820</label>
			    </li>
			    <li>
				    <input type="checkbox" value="1024" name="group[16297][1024]" id="mce-group[16297]-16297-10">
            ...
            <div style="position: absolute; left: -5000px;">
                <input type="text" name="b_fc68831e4ac2cd70f51e2693a_8e353536e3" tabindex="-1" value="">
            </div>
            <div class="clear">

<?php
/**
 * The template for displaying the Traditional Chinese (TW) home page.
 *
...
<?php
	...
	$category = 482; /* Perspectives Traditional Chinese */
...
<?php
	...
	$category = 484; /* Announcements Traditional Chinese */
